(function () {
    ...
    // sessionStorage survives page refresh/navigation within the same tab,
    // but is cleared when the tab/browser is closed - so closing and
    // reopening the site brings the splash back, while a refresh does not.
    var SESSION_FLAG = 'tecverseSplashShown';
    if (window.sessionStorage && sessionStorage.getItem(SESSION_FLAG)) {
    ...
    var countdownDisplayDuration = 4000;
    var finished = false;
    var timer;
    ...
    var splashCountdownSound = new Audio('/audio/countdown-splash.mp3');
    splashCountdownSound.preload = 'auto';
    splashCountdownSound.volume = 0.55;
    ...
    function startCountdown() {
        ...
        // Every splash appearance starts the supplied 4-second clock sound from 0.
        startSplashCountdownSound();

        updateCountdown();
        timer = window.setInterval(updateCountdown, 1000);

        // Keep the splash countdown visible for exactly 4 seconds.
    ...
    function begin() {
        ...
        // TEC-VERSE splash remains for 3 seconds, then the 4-second countdown appears.
        window.setTimeout(function () {
